-- Simplified notification templates
-- Only essential templates:
...
PRINT 'Cleared existing notification templates.';
GO
...
<body>
    <div class="container">
        ...
        <div class="content">
            <table>
                <tr><td class="label">Workflow</td><td class="value">{{WorkflowName}}</td></tr>
                <tr class="divider"><td class="label">Current Step</td><td class="value">{{WorkflowStepName}}</td></tr>
                ...
                <tr class="divider"><td class="label">Request Type</td><td class="value">{{RequestDescription}}</td></tr>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p style="margin-top: 0;">Your request has been rejected.</p>
            <table>
                <tr><td class="label">Form</td><td class="value">{{FormName}}</td></tr>
                <tr class="divider"><td class="label">Request ID</td><td class="value">{{RequestId}}</td></tr>
                <tr class="divider"><td class="label">Request Type</td><td class="value">{{RequestDescription}}</td></tr>
                <tr class="divider"><td class="label">Rejected by</td><td class="value">{{ApproverName}}</td></tr>
                <tr class="divider"><td class="label">Reason</td><td class="value">{{RejectionReason}}</td></tr>
            </table>
            <div style="text-align: center;">
                <a href="{{RequestUrl}}" class="btn">View Details</a>
            </div>
...
PRINT 'Simplified notification templates created successfully (3 templates).';
GO
