-- Migration: Add Form Sections and Grid Layout Support
-- Created: 2025-07-16
-- Description: Adds support for form sections and grid-based field positioning
...
INSERT INTO FormSections (FormDefinitionId, Name, DisplayOrder, MaxColumns, CreatedAt, CreatedBy)
SELECT DISTINCT 
    fd.Id,
    CASE 
