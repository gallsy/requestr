...
public interface IUniquenessValidationService
{
    ...
    /// </summary>
    Task<List<string>> ValidateAsync(int formDefinitionId, Dictionary<string, object?> fieldValues, RequestType requestType, Dictionary<string, object?>? originalValues = null);
}
