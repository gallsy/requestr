-- Add FormPermissions table for granular role-based access control
-- This script adds support for fine-grained permissions per form
...
PRINT 'FormPermissions table and default permissions setup completed successfully!'
GO
